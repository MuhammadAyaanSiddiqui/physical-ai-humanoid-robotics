...
const config = {
  ...
  url: process.env.VERCEL ? 'https://physical-ai-humanoid-robotics-silk.vercel.app/' : 'https://muhammadayaansiddiqui.github.io',
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/ayaan/Physical-ai-humanoid-robotics',
            label: 'GitHub',
            position: 'right',
          },
        ],
